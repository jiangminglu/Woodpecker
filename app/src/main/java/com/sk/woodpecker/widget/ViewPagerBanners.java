package com.sk.woodpecker.widget;
 ...
 *
 */
public class ViewPagerBanners extends LinearLayout {
	...
	public void setImageResources(ArrayList<String> imageUrlList,
		...
		for (int i = 0; i < imageCount; i++) {
			...
			if (i == 0) {
				mImageViews[i]
						.setBackgroundResource(R.mipmap.page_indicator_select);
			} else {
				mImageViews[i]
						.setBackgroundResource(R.mipmap.page_indicator_unselect);
			}
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			imageView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					mPagerBannersListener.onImageClick(position % mAdList.size(),v);
				}
			});
