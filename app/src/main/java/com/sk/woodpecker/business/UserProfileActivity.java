			...
			public void onSuccess(EaseUser user) {
				if (user != null) {
					...
					if(!TextUtils.isEmpty(user.getAvatar())){
						 Picasso.with(UserProfileActivity.this).load(user.getAvatar()).placeholder(R.mipmap.em_default_avatar).into(headAvatar);
					}else{
						Picasso.with(UserProfileActivity.this).load(R.mipmap.em_default_avatar).into(headAvatar);
					}
